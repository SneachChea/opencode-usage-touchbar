...
enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .zhHans: [
            ...
            "touch_bar_mode": "Touch Bar 模式", "touch_bar_mode_always": "始终显示", "touch_bar_mode_codex": "仅 Codex 前台时显示", "touch_bar_mode_disabled": "不显示", "no_usage_source": "未检测到用量来源",
            ...
            "section_pet": "宠物", "pet": "宠物", "pet_none": "无", "pet_no_pets": "未在宠物文件夹中找到宠物。", "pet_refresh": "刷新宠物", "pet_choose_folder": "选择宠物文件夹…", "pet_reset_folder": "恢复默认文件夹", "pet_folder_label": "宠物文件夹：%@", "pet_open_gallery": "打开 Codex 宠物画廊", "pet_accessibility": "宠物 %@", "pet_customization": "宠物", "pet_warning_id": "pet.json 的 id 与文件夹名称不一致。", "pet_selected_missing": "所选宠物不在当前文件夹中。", "pet_min_interval": "最小间隔", "pet_max_interval": "最大间隔",
            ...
            "go_monthly_quota": "每月额度", "monthly_prefix": "月",
            "go_quota_customization": "OpenCode Go %@额度",
        ...
        .zhHant: [
            ...
            "touch_bar_mode": "Touch Bar 模式", "touch_bar_mode_always": "始終顯示", "touch_bar_mode_codex": "僅 Codex 在前景時顯示", "touch_bar_mode_disabled": "不顯示", "no_usage_source": "未偵測到用量來源",
            ...
            "section_pet": "寵物", "pet": "寵物", "pet_none": "無", "pet_no_pets": "未在寵物資料夾中找到寵物。", "pet_refresh": "重新整理寵物", "pet_choose_folder": "選擇寵物資料夾…", "pet_reset_folder": "恢復預設資料夾", "pet_folder_label": "寵物資料夾：%@", "pet_open_gallery": "開啟 Codex 寵物畫廊", "pet_accessibility": "寵物 %@", "pet_customization": "寵物", "pet_warning_id": "pet.json 的 id 與資料夾名稱不一致。", "pet_selected_missing": "所選寵物不在目前資料夾中。", "pet_min_interval": "最小間隔", "pet_max_interval": "最大間隔",
            ...
            "go_monthly_quota": "每月額度", "monthly_prefix": "月",
            "go_quota_customization": "OpenCode Go %@額度",
        ...
        .english: [
            ...
            "touch_bar_mode": "Touch Bar mode", "touch_bar_mode_always": "Always visible", "touch_bar_mode_codex": "Only while Codex is active", "touch_bar_mode_disabled": "Disabled", "no_usage_source": "No usage source detected",
            ...
            "section_pet": "Pet", "pet": "Pet", "pet_none": "None", "pet_no_pets": "No pets found in the pets folder.", "pet_refresh": "Refresh Pets", "pet_choose_folder": "Choose Pet Folder…", "pet_reset_folder": "Reset to Default", "pet_folder_label": "Pets folder: %@", "pet_open_gallery": "Open Codex Pet Gallery", "pet_accessibility": "Pet %@", "pet_customization": "Pet", "pet_warning_id": "pet.json id does not match the folder name.", "pet_selected_missing": "The selected pet is not in the current folder.", "pet_min_interval": "Min interval", "pet_max_interval": "Max interval",
            ...
            "go_monthly_quota": "Monthly limit", "monthly_prefix": "Mo",
            "go_quota_customization": "OpenCode Go %@ limit",
        ...
        .japanese: [
            ...
            "touch_bar_mode": "Touch Bar モード", "touch_bar_mode_always": "常時表示", "touch_bar_mode_codex": "Codex 前面時のみ表示", "touch_bar_mode_disabled": "表示しない", "no_usage_source": "用量ソースが見つかりません",
            ...
            "section_pet": "ペット", "pet": "ペット", "pet_none": "なし", "pet_no_pets": "ペットフォルダにペットが見つかりません。", "pet_refresh": "ペットを更新", "pet_choose_folder": "ペットフォルダを選択…", "pet_reset_folder": "既定フォルダに戻す", "pet_folder_label": "ペットフォルダ：%@", "pet_open_gallery": "Codex ペットギャラリーを開く", "pet_accessibility": "ペット %@", "pet_customization": "ペット", "pet_warning_id": "pet.json の id がフォルダ名と一致しません。", "pet_selected_missing": "選択したペットが現在のフォルダにありません。", "pet_min_interval": "最小間隔", "pet_max_interval": "最大間隔",
            ...
            "go_monthly_quota": "月間上限", "monthly_prefix": "月",
            "go_quota_customization": "OpenCode Go %@上限",
        ...
        .korean: [
            ...
            "touch_bar_mode": "Touch Bar 모드", "touch_bar_mode_always": "항상 표시", "touch_bar_mode_codex": "Codex 활성 시에만 표시", "touch_bar_mode_disabled": "표시 안 함", "no_usage_source": "사용량 소스를 찾을 수 없음",
            ...
            "section_pet": "펫", "pet": "펫", "pet_none": "없음", "pet_no_pets": "펫 폴더에서 펫을 찾을 수 없습니다.", "pet_refresh": "펫 새로 고침", "pet_choose_folder": "펫 폴더 선택…", "pet_reset_folder": "기본 폴더로 재설정", "pet_folder_label": "펫 폴더: %@", "pet_open_gallery": "Codex 펫 갤러리 열기", "pet_accessibility": "펫 %@", "pet_customization": "펫", "pet_warning_id": "pet.json id가 폴더 이름과 일치하지 않습니다.", "pet_selected_missing": "선택한 펫이 현재 폴더에 없습니다.", "pet_min_interval": "최소 간격", "pet_max_interval": "최대 간격",
            ...
            "go_monthly_quota": "월간 한도", "monthly_prefix": "월",
            "go_quota_customization": "OpenCode Go %@ 한도",
        ...
        .spanish: [
            ...
            "touch_bar_mode": "Modo de la Touch Bar", "touch_bar_mode_always": "Siempre visible", "touch_bar_mode_codex": "Solo con Codex activo", "touch_bar_mode_disabled": "Desactivado", "no_usage_source": "No se detectó ninguna fuente de uso",
            ...
            "section_pet": "Mascota", "pet": "Mascota", "pet_none": "Ninguna", "pet_no_pets": "No se encontraron mascotas en la carpeta.", "pet_refresh": "Actualizar mascotas", "pet_choose_folder": "Elegir carpeta de mascotas…", "pet_reset_folder": "Restablecer carpeta", "pet_folder_label": "Carpeta de mascotas: %@", "pet_open_gallery": "Abrir galería de mascotas de Codex", "pet_accessibility": "Mascota %@", "pet_customization": "Mascota", "pet_warning_id": "El id de pet.json no coincide con el nombre de la carpeta.", "pet_selected_missing": "La mascota seleccionada no está en la carpeta actual.", "pet_min_interval": "Intervalo mínimo", "pet_max_interval": "Intervalo máximo",
            ...
            "go_monthly_quota": "Límite mensual", "monthly_prefix": "Mes",
            "go_quota_customization": "Límite %@ de OpenCode Go",
